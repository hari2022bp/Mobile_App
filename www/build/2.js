webpackJsonp([2],Array(339).concat([
/* 339 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VehicleAssessmentChecklistPageModule", function() { return VehicleAssessmentChecklistPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vehicle_assessment_checklist__ = __webpack_require__(499);
...
var VehicleAssessmentChecklistPageModule = /** @class */ (function () {
    function VehicleAssessmentChecklistPageModule() {
    }
    VehicleAssessmentChecklistPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__vehicle_assessment_checklist__["a" /* VehicleAssessmentChecklistPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__vehicle_assessment_checklist__["a" /* VehicleAssessmentChecklistPage */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__vehicle_assessment_checklist__["a" /* VehicleAssessmentChecklistPage */]
            ]
        })
    ], VehicleAssessmentChecklistPageModule);
    return VehicleAssessmentChecklistPageModule;
}());

//# sourceMappingURL=vehicle-assessment-checklist.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return VehicleAssessmentChecklistPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__home_home__ = __webpack_require__(469);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_angular__ = __webpack_require__(106);
...
var VehicleAssessmentChecklistPage = /** @class */ (function () {
    function VehicleAssessmentChecklistPage(http2, http, alert, loading, navctrl, storage, apiUrl) {
        this.http2 = http2;
        this.http = http;
        this.alert = alert;
        this.loading = loading;
        ...
        this.apiUrl = apiUrl;
        this.vehiclecomplianceobservations = [];
        this.date = new Date().toISOString();
        this.subject = "Checklist Upload: Vehicle Compliance Checklist";
        this.from_mailid = "asma.apron@gvk.com";
        this.cc_mailid = localStorage.getItem("email");
        this.vehicleloc = ['Domestic', 'International', 'OAP Apron'];
        this.Postheaders = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
    ...
    VehicleAssessmentChecklistPage.prototype.ionViewCanEnter = function () {
        if (!localStorage.getItem("email")) {
            alert('please sign in');
            return false;
        }
    };
    VehicleAssessmentChecklistPage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    VehicleAssessmentChecklistPage.prototype.onValidate = function () {
    ...
    VehicleAssessmentChecklistPage.prototype.addNew = function () {
    ...
    VehicleAssessmentChecklistPage.prototype.onSubmit = function () {
        var _this = this;
        ...
        this.http.post(this.apiUrl.apiUrl + '/api/VehicleComplianceMaster', JSON.stringify(postparams), { headers: this.Postheaders })
            ...
            _this.showPrompt();
            _this.sendEmail();
            _this.vehiclecomplianceobservations = null;
            _this.time = null;
            _this.endtime = null;
        }, function (error) {
            console.log(error);
        ...
        this.body = "<b>Vehicle Inspection Schedule</b> <br><br> Name Of Safety Officer Mr." + this.user + ".<br><br> Area Inspected: " + this.location + ".<br><br> Date: " + this.date + ".<br><br> DM Assigned: " + this.to_mailid + ".<br><br> Time: " + this.time + " - " + this.endtime + ".<br><br>Regards<br>ASMA";
    };
    VehicleAssessmentChecklistPage.prototype.sendEmail = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append("Content-Type", "application/json");
        var emailParams = {
            Body: this.body,
    ...
    VehicleAssessmentChecklistPage.prototype.showPrompt = function () {
        var _this = this;
    ...
    VehicleAssessmentChecklistPage.prototype.saveDataOffline = function () {
        var loader = this.loading.create({
            content: "Please wait...",
            duration: 3000
        });
    ...
    VehicleAssessmentChecklistPage.prototype.localStorageSynchronisation = function () {
        var _this = this;
        this.storage.get('VehicleChecklistOfflineData').then(function (val) {
            var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
            headers.append("Content-Type", "application/json");
            var params = val;
            _this.http.post(_this.apiUrl.apiUrl + '/api/VehicleComplianceMaster', JSON.stringify(params), { headers: _this.Postheaders })
                .map(function (res) { return res.json(); })
                .subscribe(function (data) {
                if (data == "-1") {
                    console.log('error');
