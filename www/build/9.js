webpackJsonp([9],Array(317).concat([
/* 317 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__adhoc_runway_checklist__ = __webpack_require__(477);
...
var AdhocRunwayChecklistPage = /** @class */ (function () {
    function AdhocRunwayChecklistPage(navCtrl, navParams, http2, http, datePipe, alert, loading, storage, events, apiUrl) {
        this.navCtrl = navCtrl;
        ...
        this.inspectionType = ['Adhoc Inspection'];
    ...
    AdhocRunwayChecklistPage.prototype.ionViewCanEnter = function () {
        if (!localStorage.getItem("email")) {
            alert('please sign in');
            return false;
        }
    ...
    AdhocRunwayChecklistPage.prototype.initializeForm = function () {
        this.runwaychecklistForm = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["b" /* FormGroup */]({
            ...
            'inspectiontype': new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormControl */](__WEBPACK_IMPORTED_MODULE_3__angular_forms__["g" /* Validators */].required), 'approachlightsign': new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormControl */](null),
