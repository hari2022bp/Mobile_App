webpackJsonp([12],Array(328).concat([
/* 328 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__email__ = __webpack_require__(489);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_moment__ = __webpack_require__(341);
...
var EmailPage = /** @class */ (function () {
    ...
    function EmailPage(navCtrl, navParams, iab, http2, http, alert, loading, apiUrl) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.Postheaders = new __WEBPACK_IMPORTED_MODULE_3__angular_http__["a" /* Headers */]();
        ...
        //     console.log("error has occured");
        // });
        this.http2.get(this.apiUrl.apiUrl + '/api/Department', { headers: header }).subscribe(function (data) {
            _this.departmentList = data;
        }, function (err) {
            console.log("error has occured");
        });
        this.http2.get(this.apiUrl.apiUrl + '/api/Priority', { headers: header }).subscribe(function (data) {
            _this.priorityList = data;
        }, function (err) {
            console.log("error has occured");
        });
    }
    EmailPage.prototype.ionViewCanEnter = function () {
        if (!localStorage.getItem("email")) {
            alert('please sign in');
            return false;
        }
    ...
    EmailPage.prototype.ionViewDidLoad = function () {
        this.currentdate = __WEBPACK_IMPORTED_MODULE_5_moment__().format("YYYY-MM-DD HH:MM:SS");
    ...
    EmailPage.prototype.onSubmit = function () {
        ...
        if (typeof this.imagea !== 'undefined' && this.imagea.length > 0) {
            this.imagea.forEach(function (element) {
                array.push("<a href='" + _this.apiUrl.apiUrl + "/UploadFile/" + element + "'>Email Attachment</a>");
        ...
        var body = "<span style='font-family: Adani Light'>Dear Team,</span><br><br> " + "<span style='font-family: Adani Light'>" + emailobservation + "</span> <br/> <br />" + "<span style='font-family: Adani Light'> " + array
        ...
        this.http.post(this.apiUrl.apiUrl + '/api/Email', JSON.stringify(postparams), { headers: this.Postheaders })
            ...
            // include email report id in subject of email body.
            var Subject = "*** Observation reported at Airside Operation ***";
            //sending email to respective department
            ...
            _this.http.post(_this.apiUrl.apiUrl + '/api/SendEmail', JSON.stringify(emailParams), { headers: _this.Postheaders })
                .map(function (res) { return res.json(); }).subscribe(function (data) {
            }, function (error) {
                console.log(error);
            });
