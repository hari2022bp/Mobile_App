...
class ProjectBuilder {
    ...
    */
    ...
    prepBuildFiles () {
        ...
        // Remove the proj.id/name- prefix from projects: http://issues.apache.org/jira/browse/CB-9149
        ...
        // For why we do this mapping: http://issues.apache.org/jira/browse/CB-8390
    ...
    prepEnv (opts) {
        ...
        return check_reqs.check_gradle()
            .then(function (gradlePath) {
                ...
                var distributionUrl = process.env['CORDOVA_ANDROID_GRADLE_DISTRIBUTION_URL'] || 'http\\://services.gradle.org/distributions/gradle-4.10.3-all.zip';
        ...
        return spawn(wrapper, args, { stdio: 'pipe' })
            .progress(function (stdio) {
                if (stdio.stderr) {
                    ...
                    * printed to stderr. See http://issues.apache.org/jira/browse/CB-9971 for
                    * explanation.
                    */
