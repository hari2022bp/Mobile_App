webpackJsonp([5],Array(316).concat([
/* 316 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__adhoc_runway_checklist__ = __webpack_require__(475);
...
var AdhocRunwayChecklistPage = /** @class */ (function () {
    function AdhocRunwayChecklistPage(navCtrl, navParams, http, datePipe, alert, loading, storage, events) {
        ...
        this.inspectionType = ['Adhoc Inspection', 'Afternoon Inspection', 'Dawn Inspection', 'Evening Inspection', 'Dusk Inspection', 'Morning Inspection', 'Night Inspection'];
