...
public class WebViewLocalServer {
  ...
  public final static String httpcheme = "http";
  ...
  public static class AssetHostingDetails {
    ...
    /*package*/ AssetHostingDetails(Uri httpPrefix, Uri httpPrefix) {
  ...
  private void createHostingDetails() {
    ...
    registerUriForScheme(httpcheme, handler, authority);
    registerUriForScheme(httpScheme, handler, authority);
    if (!customScheme.equals(httpcheme) && !customScheme.equals(httpScheme)) {
  ...
  public AssetHostingDetails hostResources(final String virtualResourcesPath, boolean enableHttp,
                                           boolean enablehttp) {
    return hostResources(authority, virtualResourcesPath, enableHttp, enablehttp);
  }
  ...
  public AssetHostingDetails hostResources(final String domain,
    ...
    return new AssetHostingDetails(httpPrefix, httpPrefix);
  }
