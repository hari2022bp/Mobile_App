webpackJsonp([9],Array(323).concat([
/* 323 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__email__ = __webpack_require__(482);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_moment__ = __webpack_require__(339);
...
var EmailPage = /** @class */ (function () {
    ...
    function EmailPage(navCtrl, navParams, iab, http, alert, loading) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.http.get('http://localhost:5155/api/Department').map(function (res) { return res.json(); }).subscribe(function (data) {
            _this.departmentList = data;
        }, function (err) {
            console.log("error has occured");
        });
        this.http.get('http://localhost:5155/api/Priority').map(function (res) { return res.json(); }).subscribe(function (data) {
    ...
    EmailPage.prototype.ionViewDidLoad = function () {
        this.currentdate = __WEBPACK_IMPORTED_MODULE_5_moment__().format();
    };
    EmailPage.prototype.fileChange = function (event) {
        var fileList;
        var arr = [];
        ...
        if (fileList.length > 0) {
            for (var i = 0; i < fileList.length; i++) {
                ...
                console.log("Form Data Generated" + this.formData);
            }
            this.imagea = arr;
        }
        console.dir("values" + this.imagea);
    };
    EmailPage.prototype.onValidate = function () {
    ...
    EmailPage.prototype.onSubmit = function () {
        ...
        if (typeof this.imagea !== 'undefined' && this.imagea.length > 0) {
            this.imagea.forEach(function (element) {
                array.push("<a href='http://localhost:5155/UploadFile/" + element + "'>Email Attachment</a>");
                _this.imagename = _this.imagename + ',' + element;
            });
        }
        var emailobservation = this.observation.concat("  EMAIL INITIATED ON:" + this.currentdate);
        this.csiagvklogo = "http://localhost:5155/UploadFile/Email_Signature.jpg";
        var body = "Dear Team,<br><br> " + emailobservation + "<br/> <br />" + array + "<br><br>Regards,<br>" + localStorage.getItem("username") + "<br>Airside Safety Officer - Apron Control<br><br>Mumbai International Airport Ltd<br>Chhatrapati Shivaji Maharaj International Airport LTD<br>1st Floor, Apron Control, Santacruz (E), Mumbai 400 099, India<br>T :  26264444; 26156637   Fax: 26156038  M: 9930144135<br><img src=" + this.csiagvklogo + " /><br><br><br>Our Vision for CSIA: To be one of the World’s best airports that consistently delights customers and be the pride of Mumbai<br><span style='color: green'>Please consider the environment & print this mail/attachments only if absolutely essential</span>";
        var postparams = {
        ...
        this.http.post('http://localhost:5155/api/UploadImage', JSON.stringify(this.formData), { headers: headers })
        ...
        this.http.post('http://localhost:5155/api/Email', JSON.stringify(postparams), { headers: headers2 })
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
            _this.emailaddress = data;
            var from_mailid = "asma.apron@gvk.com";
            var to_mailid = "";
            for (var _i = 0, _a = _this.emailaddress; _i < _a.length; _i++) {
                var emailid = _a[_i];
                to_mailid = to_mailid + emailid + ";";
            }
            var cc_mailid;
            var username = "Apron Control Team";
            // include email report id in subject of email body.
            var Subject = "*** Observation reported in Airside Operation ***";
            //sending email to respective department       
            var headers3 = new __WEBPACK_IMPORTED_MODULE_3__angular_http__["a" /* Headers */]();
            ...
            _this.http.post('http://localhost:5155/api/SendEmail', JSON.stringify(emailParams), { headers: headers3 })
                .map(function (res) { return res.json(); }).subscribe(function (data) {
            }, function (error) {
                console.log(error);
            });
    ...
    EmailPage.prototype.showPrompt = function () {
        var _this = this;
    ...
    EmailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-email',template:/*ion-inline-start:"F:\DevelopmentWorkloads\ASMA_Mobile_Application\src\pages\email\email.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title text-center color="primary">\n      <p style="color:blue">Email</p>\n    </ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <ion-item>\n\n    <ion-label floating style="color: black; text-align: center; font-weight: bold;"> Select Department </ion-label>\n\n    <ion-select name="department" [(ngModel)]="department" ngModel required>\n      <ion-option *ngFor="let dept of departmentList" [value]="dept.Dept_ID"> {{ dept.DepartmentName }} </ion-option>\n    </ion-select>\n\n  </ion-item>\n\n  <ion-item>\n\n    <ion-label floating style="color: black; text-align: center; font-weight: bold;"> Select Priority </ion-label>\n\n    <ion-select name="priority" [(ngModel)]="priority" ngModel required>\n      <ion-option *ngFor="let item of priorityList" [value]="item.PriorityID"> {{ item.PName }} </ion-option>\n    </ion-select>\n\n  </ion-item>\n\n  <ion-item>\n\n      <ion-label floating style="color: black; text-align: center; font-weight: bold;">Observation Found</ion-label>\n\n      <ion-textarea name="observation" [(ngModel)]="observation"></ion-textarea>\n\n  </ion-item>\n\n  <ion-item>\n\n      <!-- <span class="tim-note" style="color: #282828; font-weight: bold;">Upload Image</span> -->\n\n      <!-- <ion-label floating style="color: black; text-align: center; font-weight: bold;">Upload Image</ion-label> -->\n\n      <input type="file" id="observationImageUpload" value="Upload" (change)="fileChange($event)" multiple >\n\n  </ion-item>\n\n  <button [disabled]="onValidate()" ion-button type="submit" (click) = "onSubmit()" block>Send Email</button>\n\n</ion-content>'/*ion-inline-end:"F:\DevelopmentWorkloads\ASMA_Mobile_Application\src\pages\email\email.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_in_app_browser__["a" /* InAppBrowser */], __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* Http */],
