webpackJsonp([1],Array(336).concat([
/* 336 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__runway_checklist__ = __webpack_require__(494);
...
var RunwayChecklistPage = /** @class */ (function () {
    function RunwayChecklistPage(navCtrl, navParams, http, datePipe, alert, loading, storage, events) {
        this.navCtrl = navCtrl;
        ...
        this.inspectionType = ['Adhoc Inspection', 'Afternoon Inspection', 'Dawn Inspection', 'Dusk Inspection', 'Morning Inspection', 'Night Inspection'];
        // STATUS //
    ...
    RunwayChecklistPage.prototype.initializeForm = function () {
        this.runwaychecklistForm = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["b" /* FormGroup */]({
            ...
            'sequentialflashinglightAction': new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormControl */](null),
    ...
    RunwayChecklistPage.prototype.onSubmit = function () {
        ...
        loader.present();
        this.http.post('http://localhost:5155/RunwayChecklist/InsertNewRunwayChecklist', JSON.stringify(postparams), { headers: headers })
    ...
    RunwayChecklistPage.prototype.localStorageSynchronisation = function () {
        ...
        this.storage.get('RunwayChecklistOfflineData').then(function (val) {
            ...
            headers.append("Content-Type", "application/json");
            var params = val;
            _this.http.post('http://localhost:5155/RunwayChecklist/InsertNewRunwayChecklist', JSON.stringify(params), { headers: headers })
                .map(function (res) { return res.json(); })
                .subscribe(function (data) {
                if (data == "-1") {
                    console.log('error');
