webpackJsonp([11],Array(316).concat([
/* 316 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__adhoc_vehicle_assessment_checklist__ = __webpack_require__(475);
...
var AdhocVehicleAssessmentChecklistPage = /** @class */ (function () {
    function AdhocVehicleAssessmentChecklistPage(http, alert, loading, navctrl, storage) {
        this.http = http;
        this.alert = alert;
        this.loading = loading;
        this.navctrl = navctrl;
