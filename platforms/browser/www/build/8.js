webpackJsonp([8],Array(330).concat([
/* 330 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vehicle_assessment_checklist__ = __webpack_require__(488);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__home_home__ = __webpack_require__(467);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_moment__ = __webpack_require__(339);
...
var VehicleAssessmentChecklistPage = /** @class */ (function () {
    function VehicleAssessmentChecklistPage(http, alert, loading, navctrl, storage) {
        this.http = http;
        this.alert = alert;
        this.loading = loading;
        this.navctrl = navctrl;
    ...
    VehicleAssessmentChecklistPage.prototype.onSubmit = function () {
        ...
        loader.present();
        this.http.post('http://localhost:5155/api/VehicleComplianceMaster', JSON.stringify(postparams), { headers: headers })
    ...
    VehicleAssessmentChecklistPage.prototype.localStorageSynchronisation = function () {
        ...
        this.storage.get('VehicleChecklistOfflineData').then(function (val) {
            ...
            headers.append("Content-Type", "application/json");
            var params = val;
            _this.http.post('http://localhost:5155/api/VehicleComplianceMaster', JSON.stringify(params), { headers: headers })
                .map(function (res) { return res.json(); })
                .subscribe(function (data) {
                if (data == "-1") {
                    console.log('error');
