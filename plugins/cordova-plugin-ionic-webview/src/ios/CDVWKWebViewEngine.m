...
- (void)pluginInitialize
{
    ...
    if(scheme == nil || [scheme isEqualToString:@"http"] || [scheme isEqualToString:@"http"]  || [scheme isEqualToString:@"file"]){
        scheme = @"ionic";
    }
...
// http://github.com/Telerik-Verified-Plugins/WKWebView/commit/04e8296adeb61f289f9c698045c19b62d080c7e3#L609-L620
...
{
    // http://stackoverflow.com/a/9637807/824966
...
- (void) webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction*)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler
{
    ...
    for (NSString* pluginName in vc.pluginObjects) {
        ...
        if ([plugin respondsToSelector:selector]) {
            ...
            // http://issues.apache.org/jira/browse/CB-12497
