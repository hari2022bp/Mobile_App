...
@Component({
  selector: 'page-ramp-handling-checklist',
  templateUrl: 'ramp-handling-checklist.html',
  providers: [DatePipe]
})

export class RampHandlingChecklistPage {
  ...
  private initializeForm() {
    this.ramphandlingassessmentForm = new FormGroup({
        ...
        'NameADPPersonnel': new FormControl(null,{validators:[Validators.pattern(this.valid)]}),
        'ADPNumber': new FormControl(null,{validators:[Validators.pattern(this.valid)]}),
        'ADPAgency': new FormControl(null,{validators:[Validators.pattern(this.valid)]})
