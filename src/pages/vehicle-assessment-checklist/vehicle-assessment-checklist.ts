...
@Component({
  selector: 'page-vehicle-assessment-checklist',
  templateUrl: 'vehicle-assessment-checklist.html',
  providers: [DatePipe]
})

export class VehicleAssessmentChecklistPage {
  ...
  endtime:string;
  location:string;
  public subject: string = "Checklist Upload: Vehicle Compliance Checklist";
  ...
  constructor(public http2:HttpClient,public http:Http, public alert: AlertController, public loading: LoadingController,
